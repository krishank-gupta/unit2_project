...
| 4       |                       Adding the new sensors to  the server                      |                                Having stored sensors in the server                               |     20 min    | Dec 04                 | C         |
## Test Plan
