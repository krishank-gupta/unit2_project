...
| The background of the graphs            | Functional     | ggplot theme                                                                                                                                                                                                                                                                                                                                                                              | A graph that is plotted in a gray background(The gray background is a result of ggplot)     |
| User registration                       | Non-functional | user = ({"username": "Krish&Thumula", "password":"###"}).json()                                                                                                                                                                                                                                                                                                                           | The same dictionary is returned                                                             |
| Posting new sensors                     | Non-functional | temp_hum = ({                "name": f"Krish&Thumula Hum{i}",                "unit": "%",                "location": "R1-14B",                "type": "Humditiy"                }).json() temp_temp = ({                "name": f"Krish&Thumula Temp{i}",                "unit": "C",                "location": "R1-14B",                "type": "Temperature"                 }).json() | The server returns the details of the sensor registered in the server                       |
| Prediction graphs                       | Non-functional | The cubic equation for the graph                                                                                                                                                                                                                                                                                                                                                          | The predictedion is given by a blue crossed line which will be connected to the cubic graph |
