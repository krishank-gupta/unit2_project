...
created the dictionaries are converted to JSON and then posted to http://192.168.6.142/sensor/new. And finally the function gives out the sensor id of the newly uploaded
sensors' id and owner's id with details that were given when sensors were being uploaded to the server( name, unit, location and type).
